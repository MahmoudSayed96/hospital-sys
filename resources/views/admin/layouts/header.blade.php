...
<header class="app-header">
    <a class="app-header__logo" href="{{admin_route()}}">
    ...
    <ul class="app-nav">
        ...
        <!-- Visite site link -->
        <li>
            <a class="app-nav__item" href="/" data-toggle="tooltip" data-placement="bottom" title="Visite site">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
                <li><a class="dropdown-item" href="{{admin_route('settings.index')}}"><i class="fa fa-cog fa-lg"></i>
                        Settings</a></li>
